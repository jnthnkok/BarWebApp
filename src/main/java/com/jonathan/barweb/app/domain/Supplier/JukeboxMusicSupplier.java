 ...
 */
@Entity
public class JukeboxMusicSupplier implements Supplier, Serializable
{
	...
	{
        return "com.jonathan.barweb.app.domain.Supplier.JukeboxMusicSupplier[ id=" + id + " ]";
    }
